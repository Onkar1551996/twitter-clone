			...
			<div className="col2-home">
					<div className="col2-home-body">
						<Link to="/home" id="homelink">
								<div id="hmlnktxt">Home</div>
						</Link>
						<div id="wrttwt">
								<div id="inside1">
										<div id="piccolumn">
												<img alt="Onkar Pawar" draggable="true" src="https://pbs.twimg.com/profile_images/948840469756231680/urDZaft7_bigger.jpg" className="imgprop" />
										</div>
										<div id="inputandattach">
												<div id="inputcolumn">
														<input type="text" placeholder="What's happening?" className="twttext" />
												</div>
												{ <div id="twtprivacy">
												...
												<div id="attachandtwt">
														<div id="attach">
																<div className="svgdiv">
																		<svg width="24" height="24" viewBox="0 0 24 24" className="attachsvg">
